...
private:
	...
	float Shininess;
public:
	Material(glm::vec3 Ambient, glm::vec3 Difuse, glm::vec3 Specular, float Shininess);
	...
	void SetDifuseUniforms(Shader shader);
	void SetSpecularUniforms(Shader shader);
	void SetShininessUniforms(Shader shader);
};
